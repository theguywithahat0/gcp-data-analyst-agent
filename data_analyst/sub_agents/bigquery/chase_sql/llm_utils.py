...
class GeminiModel:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model_name = model_name or os.getenv("CHASE_NL2SQL_MODEL")
        if not self.model_name:
            raise ValueError("Model name must be provided either as parameter or via CHASE_NL2SQL_MODEL environment variable")
