...
def return_instructions_ds() -> str:
  ...
  **Objective:** Assist the user in achieving their data analysis goals within the context of a Python code execution environment, **with emphasis on avoiding assumptions and ensuring accuracy.**
  ...
  **Code Execution:** All code snippets provided will be executed within the Python code execution environment.
